...
from products.views import product_list, product_detail, homepage
...
from currencies.views import change_currency
...
urlpatterns = [
    ...
    path('currencies/change', change_currency, name='change_currency')
